...
class DHGroupChoices(ChoiceSet):
    ...
    CHOICES = (
        ...
        (GROUP_1, _('Group %(n)s') % {'n': 1}),
        (GROUP_2, _('Group %(n)s') % {'n': 2}),
        (GROUP_5, _('Group %(n)s') % {'n': 5}),
        (GROUP_14, _('Group %(n)s') % {'n': 14}),
        (GROUP_15, _('Group %(n)s') % {'n': 15}),
        (GROUP_16, _('Group %(n)s') % {'n': 16}),
        (GROUP_17, _('Group %(n)s') % {'n': 17}),
        (GROUP_18, _('Group %(n)s') % {'n': 18}),
        (GROUP_19, _('Group %(n)s') % {'n': 19}),
        (GROUP_20, _('Group %(n)s') % {'n': 20}),
        (GROUP_21, _('Group %(n)s') % {'n': 21}),
        (GROUP_22, _('Group %(n)s') % {'n': 22}),
        (GROUP_23, _('Group %(n)s') % {'n': 23}),
        (GROUP_24, _('Group %(n)s') % {'n': 24}),
        (GROUP_25, _('Group %(n)s') % {'n': 25}),
        (GROUP_26, _('Group %(n)s') % {'n': 26}),
        (GROUP_27, _('Group %(n)s') % {'n': 27}),
        (GROUP_28, _('Group %(n)s') % {'n': 28}),
        (GROUP_29, _('Group %(n)s') % {'n': 29}),
        (GROUP_30, _('Group %(n)s') % {'n': 30}),
        (GROUP_31, _('Group %(n)s') % {'n': 31}),
        (GROUP_32, _('Group %(n)s') % {'n': 32}),
        (GROUP_33, _('Group %(n)s') % {'n': 33}),
        (GROUP_34, _('Group %(n)s') % {'n': 34}),
    )
